...
export const sectorPhotos:Record<string,{hero:string;services:Record<number,{image:string;alt:string;copy:string}>}>={
 offices:{hero:'office-hero',services:{
 ...
 healthcare:{hero:'clinic-hero',services:{
 ...
 education:{hero:'school-hero',services:{
 ...
 hospitality:{hero:'hotel-hero',services:{
