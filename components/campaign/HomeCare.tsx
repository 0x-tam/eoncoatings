...
export default function HomeCare(){
 ...
 return <div className="care-editorial">
  ...
  <section className="care-section care-spaces" id="spaces-we-care-for" aria-labelledby="home-spaces-title"><div className="care-range-heading"><div><p className="eyebrow">Villas, homes &amp; commercial properties</p><h2 id="home-spaces-title">Properties we service.</h2></div><p>Care for your villa, from AC systems to furniture and stone surfaces.</p></div><SpacesGallery/></section>
