...
export default function HomeCare(){
 ...
 return <div className="care-editorial">
  <section id="services" className="care-section care-air">
   <div className="care-section-intro"><p className="eyebrow">A little care. A better everyday.</p><h2>Start with the air.<br/>Care for everything else.</h2></div>
   <div className="care-air-layout"><figure><img src="/images/unique-care/home-air.webp" alt="A fitted air-conditioning grille in a bright interior" width="1100" height="800" loading="lazy"/><figcaption>AC care for homes and workplaces</figcaption></figure><div className="care-air-copy"><p className="eyebrow">01 / AC care</p><h3>What’s inside your ducts<br/>matters to your space.</h3><p>Dust and debris can build up out of sight. EON cleans AC ducts and helps you choose suitable sanitisation and mold-resistant protection.</p><div className="care-air-steps"><span><b>01</b> Clean away buildup</span><span><b>02</b> Discuss sanitisation</span><span><b>03</b> Protect suitable ductwork</span></div><Link href="/services/ac-duct-mold-resistant-coating/" className="care-link">Explore AC care <span aria-hidden="true">›</span></Link></div></div>
  </section>
  <section ref={selectorRef} className="care-section care-range" aria-labelledby="care-range-title"><div className="care-range-heading"><div><p className="eyebrow">The complete care collection</p><h2 id="care-range-title">Different materials.<br/>The right attention.</h2></div><p>Choose what needs care. Explore the service, the surface and what it can help protect.</p></div>
  ...
  <section id="why-eon" className="care-section care-reasons" aria-labelledby="care-reasons-title"><div className="care-range-heading"><div><p className="eyebrow">What sets EON apart</p><h2 id="care-reasons-title">Why choose EON?</h2></div><p>Professional care, from choosing the treatment to looking after your space afterwards.</p></div><div className="care-reasons-grid">{[
  ...
  <section className="care-proof"><div className="care-proof-inner"><div className="care-proof-copy"><p className="eyebrow">The EON difference</p><span className="care-hgpp-word">HGPP</span><h2>Care you can<br/>put on display.</h2><p>The HealthGuard Protection Program gives qualifying treated premises a conformity certificate to display.</p><p>A visible way to communicate your commitment to surface hygiene, backed by a conversation about the treatment and ongoing care.</p><Link href="/hgpp-certification/" className="button">Explore HGPP certification <span aria-hidden="true">›</span></Link></div><HGPPCertificate/></div></section>
  <section className="care-section care-spaces" id="spaces-we-care-for" aria-labelledby="home-spaces-title"><div className="care-range-heading"><div><p className="eyebrow">At home. At work. EON has you covered.</p><h2 id="home-spaces-title">Care that fits your surroundings.</h2></div><p>Explore the spaces we care for.</p></div><SpacesGallery/></section>
  <section className="care-section care-next"><div><p className="eyebrow">Let’s find your next step</p><h2>Tell us what<br/>needs attention.</h2><p>Start with a few simple questions about your space. We’ll help you find the relevant services.</p><button className="button" onClick={()=>window.dispatchEvent(new Event('eon:finder'))}>Find my service <span aria-hidden="true">›</span></button><Link href="/contact-us/" className="care-secondary">Already know what you need? Contact EON</Link></div><div className="care-next-details"><ol><li><span>01</span><div><h3>Choose your care</h3><p>Tell us about the system, material or room.</p></div></li><li><span>02</span><div><h3>Talk through the details</h3><p>Share its condition, your location and what you want to address.</p></div></li><li><span>03</span><div><h3>Plan the work</h3><p>Confirm the service, timing and aftercare with EON.</p></div></li></ol><details><summary>Cleaning or coating?</summary><p>Cleaning removes accumulated dirt. Sanitisation and protective coatings have different purposes. The right approach depends on the material and its condition.</p></details><details><summary>More than one service?</summary><p>Yes. Share everything that needs attention so EON can discuss the requirements together.</p></details></div></section>
 </div>
}
