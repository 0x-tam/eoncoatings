...
export const materialTraces:Record<'stone'|'fabric'|'air',Trace[]> = {
 stone:[
  ...
  {title:'Within the pores',point:[945,725],copy:'Tiny openings in stone can hold dirt and spills. We help you choose protection suited to the finish.',service:'Explore stone protection',slug:'marble-protective-coatings'},
 ...
 fabric:[
  ...
  {title:'Beyond visible dirt',point:[1460,700],copy:'Fabrics can hold allergens and germs you cannot see. Ask us about deep cleaning and sanitisation.',service:'Explore upholstery care',slug:'deep-cleaning-of-carpets-furniture'},
